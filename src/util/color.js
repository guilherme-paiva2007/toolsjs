...
class Color {
    ...
    constructor(format, values, alpha = 1) {
        ...
        switch (format) {
            case "hex":
                ...
                for (const char of values) if (!Color.#validHexChars.includes(char)) throw new TypeError("Valores de cor HEX precisam ser alfanuméricos hexadecimais");
            ...
            case "hsl":
                ...
                if (saturation_hsl === 0) {
                    ...
                    r = Color.#hslToRGB(p, q, hue_hsl + 1 / 3);
                    g = Color.#hslToRGB(p, q, hue_hsl);
                    b = Color.#hslToRGB(p, q, hue_hsl - 1 / 3);
                }
    ...
    static #validHexChars = "0123456789ABCDEFabcdef".split("");
    ...
    static validhex(colorStr = "") {
        ...
        for (const char of colorStr) if (!Color.#validHexChars.includes(char)) return false;
